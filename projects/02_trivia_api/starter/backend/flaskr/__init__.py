...
def create_app(test_config=None):
  ...
  '''
    ...
    def get_search_question():
        ...
        questions = Question.query.with_entities(Question, Category)\
  ...
  '''
    ...
    def get_questions_by_categories(category_id):
        category = Category.query.with_entities(Category.type)\
            .filter_by(id=category_id).one_or_none()
        if category is None:
            abort(404)
        questions = Question.query.with_entities(Question, Category.type)\
            .join(Category, Category.id == Question.category)\
